//! Auto-generated TF-shaped projection models.
//!
//! Each submodule corresponds to one entry under
//! `crates/winterbaume-terraform/specs/`. Files here are produced by
//! `tf-converter-codegen gen <service>` and must not be edited by hand.
