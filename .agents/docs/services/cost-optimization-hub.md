...
- Operations: `ListEfficiencyMetrics`, `ListEnrollmentStatuses`, `ListRecommendationSummaries`, `ListRecommendations`
- Traits: `paginated` (4), `readonly` (4)
- Common required input members in this group: `granularity`, `groupBy`, `timePeriod`

### Get

- Operations: `GetPreferences`, `GetRecommendation`
- Traits: `readonly` (2)
- Common required input members in this group: `recommendationId`
...
| `GetPreferencesRequest` | `structure` | - | - |
| `GetPreferencesResponse` | `structure` | `memberAccountDiscountVisibility`, `preferredCommitment`, `savingsEstimationMode` | - |
| `GetRecommendationRequest` | `structure` | `recommendationId` | - |
| `GetRecommendationResponse` | `structure` | `accountId`, `actionType`, `costCalculationLookbackPeriodInDays`, `currencyCode`, `currentResourceDetails`, `currentResourceType`, `estimatedMonthlyCost`, `estimatedMonthlySavings`, `estimatedSavingsOverCostCalculationLookbackPeriod`, `estimatedSavingsPercentage`, `implementationEffort`, `lastRefreshTimestamp`, ... (+11) | - |
...
| `ListEfficiencyMetricsRequest` | `structure` | `granularity`, `groupBy`, `maxResults`, `nextToken`, `orderBy`, `timePeriod` | - |
| `ListEfficiencyMetricsResponse` | `structure` | `efficiencyMetricsByGroup`, `nextToken` | - |
| `ListEnrollmentStatusesRequest` | `structure` | `accountId`, `includeOrganizationInfo`, `maxResults`, `nextToken` | - |
| `ListEnrollmentStatusesResponse` | `structure` | `includeMemberAccounts`, `items`, `nextToken` | - |
| `ListRecommendationSummariesRequest` | `structure` | `filter`, `groupBy`, `maxResults`, `metrics`, `nextToken` | - |
| `ListRecommendationSummariesResponse` | `structure` | `currencyCode`, `estimatedTotalDedupedSavings`, `groupBy`, `items`, `metrics`, `nextToken` | - |
| `ListRecommendationsRequest` | `structure` | `filter`, `includeAllRecommendations`, `maxResults`, `nextToken`, `orderBy` | - |
| `ListRecommendationsResponse` | `structure` | `items`, `nextToken` | - |
| `UpdateEnrollmentStatusRequest` | `structure` | `includeMemberAccounts`, `status` | - |
| `UpdateEnrollmentStatusResponse` | `structure` | `status` | - |
| `UpdatePreferencesRequest` | `structure` | `memberAccountDiscountVisibility`, `preferredCommitment`, `savingsEstimationMode` | - |
| `UpdatePreferencesResponse` | `structure` | `memberAccountDiscountVisibility`, `preferredCommitment`, `savingsEstimationMode` | - |
