...
| `CreateRateBasedRuleResponse` | `structure` | `ChangeToken`, `Rule` | - |
| `CreateRegexMatchSetRequest` | `structure` | `ChangeToken`, `Name` | - |
| `CreateRegexMatchSetResponse` | `structure` | `ChangeToken`, `RegexMatchSet` | - |
