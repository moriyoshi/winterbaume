...
- Common required input members in this group: `ClusterName`, `IamRoleArn`, `NodeType`, `ParameterGroupName`, `ReplicationFactor`, `SubnetGroupName`, `SubnetIds`

### Delete

- Operations: `DeleteCluster`, `DeleteParameterGroup`, `DeleteSubnetGroup`
- Common required input members in this group: `ClusterName`, `ParameterGroupName`, `SubnetGroupName`

### Update

- Operations: `UpdateCluster`, `UpdateParameterGroup`, `UpdateSubnetGroup`
- Common required input members in this group: `ClusterName`, `ParameterGroupName`, `ParameterNameValues`, `SubnetGroupName`

### Decrease

- Operations: `DecreaseReplicationFactor`
- Common required input members in this group: `ClusterName`, `NewReplicationFactor`
...
- Common required input members in this group: `ClusterName`, `NodeId`
...
|---|---|---|---|---|---|---|---|
| `CreateCluster` | - | - | `ClusterName`, `IamRoleArn`, `NodeType`, `ReplicationFactor` | - | `CreateClusterResponse` | `ClusterAlreadyExistsFault`, `ClusterQuotaForCustomerExceededFault`, `InsufficientClusterCapacityFault`, `InvalidClusterStateFault`, `InvalidParameterCombinationException`, `InvalidParameterGroupStateFault`, `InvalidParameterValueException`, `InvalidVPCNetworkStateFault`, ... (+7) | Creates a DAX cluster. All nodes in the cluster run the same DAX caching software. |
...
| `IncreaseReplicationFactor` | - | - | `ClusterName`, `NewReplicationFactor` | - | `IncreaseReplicationFactorResponse` | `ClusterNotFoundFault`, `InsufficientClusterCapacityFault`, `InvalidClusterStateFault`, `InvalidParameterCombinationException`, `InvalidParameterValueException`, `InvalidVPCNetworkStateFault`, `NodeQuotaForClusterExceededFault`, `NodeQuotaForCustomerExceededFault`, ... (+1) | Adds one or more nodes to a DAX cluster. |
...
| `RebootNode` | - | - | `ClusterName`, `NodeId` | - | `RebootNodeResponse` | `ClusterNotFoundFault`, `InvalidClusterStateFault`, `InvalidParameterCombinationException`, `InvalidParameterValueException`, `NodeNotFoundFault`, `ServiceLinkedRoleNotFoundFault` | Reboots a single node of a DAX cluster. The reboot action takes place as soon as possible. |
...
| `SubnetNotAllowedFault` | `structure` | `message` | The specified subnet can't be used for the requested network type. |
...
| `CreateClusterRequest` | `structure` | `AvailabilityZones`, `ClusterEndpointEncryptionType`, `ClusterName`, `Description`, `IamRoleArn`, `NetworkType`, `NodeType`, `NotificationTopicArn`, `ParameterGroupName`, `PreferredMaintenanceWindow`, `ReplicationFactor`, `SSESpecification`, ... (+3) | - |
...
| `ServiceQuotaExceededException` | `structure` | - | You have reached the maximum number of x509 certificates that can be created for encrypted clusters in a 30 day period. |
| `CreateParameterGroupRequest` | `structure` | `Description`, `ParameterGroupName` | - |
