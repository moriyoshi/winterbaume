...
- Traits: `paginated` (13)
- Common required input members in this group: `Arn`, `ClusterArn`, `ResourceArn`
...
- Common required input members in this group: `Arn`, `ClusterArn`, `ConfigurationInfo`, `ConnectivityInfo`, `CurrentVersion`, `Rebalancing`, `ReplicatorArn`, `ServerProperties`, `SourceKafkaClusterArn`, `TargetBrokerEBSVolumeInfo`, `TargetInstanceType`, `TargetKafkaClusterArn`, `TargetKafkaVersion`, `TargetNumberOfBrokerNodes`, `TopicName`
...
- Traits: `paginated` (1)
- Common required input members in this group: `Arn`, `ClusterArn`, `ClusterOperationArn`, `ReplicatorArn`, `Revision`, `TopicName`

### Create

- Operations: `CreateCluster`, `CreateClusterV2`, `CreateConfiguration`, `CreateReplicator`, `CreateTopic`, `CreateVpcConnection`
- Common required input members in this group: `Authentication`, `BrokerNodeGroupInfo`, `ClientSubnets`, `ClusterArn`, `ClusterName`, `KafkaClusters`, `KafkaVersion`, `Name`, `NumberOfBrokerNodes`, `PartitionCount`, `ReplicationFactor`, `ReplicationInfoList`, `ReplicatorName`, `SecurityGroups`, `ServerProperties`, `ServiceExecutionRoleArn`, `TargetClusterArn`, `TopicName`, `VpcId`

### Delete

- Operations: `DeleteCluster`, `DeleteClusterPolicy`, `DeleteConfiguration`, `DeleteReplicator`, `DeleteTopic`, `DeleteVpcConnection`
- Common required input members in this group: `Arn`, `ClusterArn`, `ReplicatorArn`, `TopicName`
...
- Common required input members in this group: `ClusterArn`, `Policy`

### Reboot

- Operations: `RebootBroker`
- Common required input members in this group: `BrokerIds`, `ClusterArn`

### Reject

- Operations: `RejectClientVpcConnection`
- Common required input members in this group: `ClusterArn`, `VpcConnectionArn`
...
| `CreateTopic` | `POST /v1/clusters/{ClusterArn}/topics` | - | `ClusterArn`, `PartitionCount`, `ReplicationFactor`, `TopicName` | - | `CreateTopicResponse` | `BadRequestException`, `ClusterConnectivityException`, `ConflictException`, `ControllerMovedException`, `ForbiddenException`, `GroupSubscribedToTopicException`, `InternalServerErrorException`, `KafkaRequestException`, ... (+8) | Creates a topic in the specified MSK cluster. |
| `CreateVpcConnection` | `POST /v1/vpc-connection` | - | `Authentication`, `ClientSubnets`, `SecurityGroups`, `TargetClusterArn`, `VpcId` | - | `CreateVpcConnectionResponse` | `BadRequestException`, `ForbiddenException`, `InternalServerErrorException`, `ServiceUnavailableException`, `TooManyRequestsException`, `UnauthorizedException` | Creates a new MSK VPC connection. |
...
| `DeleteTopic` | `DELETE /v1/clusters/{ClusterArn}/topics/{TopicName}` | - | `ClusterArn`, `TopicName` | - | `DeleteTopicResponse` | `BadRequestException`, `ClusterConnectivityException`, `ControllerMovedException`, `ForbiddenException`, `GroupSubscribedToTopicException`, `InternalServerErrorException`, `KafkaRequestException`, `KafkaTimeoutException`, ... (+4) | Deletes a topic in the specified MSK cluster. |
...
| `UpdateConnectivity` | `PUT /v1/clusters/{ClusterArn}/connectivity` | - | `ClusterArn`, `ConnectivityInfo`, `CurrentVersion` | - | `UpdateConnectivityResponse` | `BadRequestException`, `ForbiddenException`, `InternalServerErrorException`, `NotFoundException`, `ServiceUnavailableException`, `UnauthorizedException` | Updates the cluster's connectivity configuration. |
| `UpdateMonitoring` | `PUT /v1/clusters/{ClusterArn}/monitoring` | - | `ClusterArn`, `CurrentVersion` | - | `UpdateMonitoringResponse` | `BadRequestException`, `ForbiddenException`, `InternalServerErrorException`, `ServiceUnavailableException`, `UnauthorizedException` | Updates the monitoring settings for the cluster. You can use this operation to specify which Apache Kafka metrics you want Amazon MSK to send to Amazon CloudWatch. |
...
| `UpdateReplicationInfo` | `PUT /replication/v1/replicators/{ReplicatorArn}/replication-info` | - | `CurrentVersion`, `ReplicatorArn`, `SourceKafkaClusterArn`, `TargetKafkaClusterArn` | - | `UpdateReplicationInfoResponse` | `BadRequestException`, `ForbiddenException`, `InternalServerErrorException`, `NotFoundException`, `ServiceUnavailableException`, `TooManyRequestsException`, `UnauthorizedException` | Updates replication info of a replicator. |
...
| `CreateClusterRequest` | `structure` | `BrokerNodeGroupInfo`, `ClientAuthentication`, `ClusterName`, `ConfigurationInfo`, `EncryptionInfo`, `EnhancedMonitoring`, `KafkaVersion`, `LoggingInfo`, `NumberOfBrokerNodes`, `OpenMonitoring`, `Rebalancing`, `StorageMode`, ... (+1) | - |
| `CreateClusterResponse` | `structure` | `ClusterArn`, `ClusterName`, `State` | - |
| `CreateClusterV2Request` | `structure` | `ClusterName`, `Provisioned`, `Serverless`, `Tags` | - |
