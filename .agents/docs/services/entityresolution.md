...
- Traits: `readonly` (9)
- Common required input members in this group: `arn`, `idNamespaceName`, `jobId`, `providerName`, `providerServiceName`, `record`, `schemaName`, `workflowName`
...
- Common required input members in this group: `resourceArn`, `workflowName`

### Delete

- Operations: `DeleteIdMappingWorkflow`, `DeleteIdNamespace`, `DeleteMatchingWorkflow`, `DeletePolicyStatement`, `DeleteSchemaMapping`
- Traits: `idempotent` (5)
- Common required input members in this group: `arn`, `idNamespaceName`, `schemaName`, `statementId`, `workflowName`

### Create

- Operations: `CreateIdMappingWorkflow`, `CreateIdNamespace`, `CreateMatchingWorkflow`, `CreateSchemaMapping`
- Common required input members in this group: `idMappingTechniques`, `idNamespaceName`, `inputSourceConfig`, `mappedInputFields`, `outputSourceConfig`, `resolutionTechniques`, `roleArn`, `schemaName`, `type`, `workflowName`

### Update

- Operations: `UpdateIdMappingWorkflow`, `UpdateIdNamespace`, `UpdateMatchingWorkflow`, `UpdateSchemaMapping`
- Traits: `idempotent` (4)
- Common required input members in this group: `idMappingTechniques`, `idNamespaceName`, `inputSourceConfig`, `mappedInputFields`, `outputSourceConfig`, `resolutionTechniques`, `roleArn`, `schemaName`, `workflowName`
...
- Traits: `idempotent` (1)
- Common required input members in this group: `action`, `arn`, `effect`, `principal`, `statementId`

### Batch

- Operations: `BatchDeleteUniqueId`
- Common required input members in this group: `uniqueIds`, `workflowName`

### Generate

- Operations: `GenerateMatchId`
- Common required input members in this group: `records`, `workflowName`

### Put

- Operations: `PutPolicy`
- Traits: `idempotent` (1)
- Common required input members in this group: `arn`, `policy`
...
|---|---|---|---|---|---|---|---|
| `AddPolicyStatement` | `POST /policies/{arn}/{statementId}` | `idempotent` | `action`, `arn`, `effect`, `principal`, `statementId` | - | `AddPolicyStatementOutput` | `AccessDeniedException`, `ConflictException`, `InternalServerException`, `ResourceNotFoundException`, `ThrottlingException`, `ValidationException` | Adds a policy statement object. To retrieve a list of existing policy statements, use the `GetPolicy` API. |
| `BatchDeleteUniqueId` | `DELETE /matchingworkflows/{workflowName}/uniqueids` | - | `uniqueIds`, `workflowName` | - | `BatchDeleteUniqueIdOutput` | `InternalServerException`, `ResourceNotFoundException`, `ValidationException` | Deletes multiple unique IDs in a matching workflow. |
| `CreateIdMappingWorkflow` | `POST /idmappingworkflows` | - | `idMappingTechniques`, `inputSourceConfig`, `workflowName` | - | `CreateIdMappingWorkflowOutput` | `AccessDeniedException`, `ConflictException`, `ExceedsLimitException`, `InternalServerException`, `ThrottlingException`, `ValidationException` | Creates an `IdMappingWorkflow` object which stores the configuration of the data processing job to be run. Each `IdMappingWorkflow` must have a unique workflow name. |
...
| `TagResource` | `POST /tags/{resourceArn}` | - | `resourceArn`, `tags` | - | `TagResourceOutput` | `InternalServerException`, `ResourceNotFoundException`, `ValidationException` | Assigns one or more tags (key-value pairs) to the specified Entity Resolution resource. Tags can help you organize and categorize your resources. |
...
| `ConflictException` | `structure` | `message` | The request couldn't be processed because of conflict in the current state of the resource. |
| `ExceedsLimitException` | `structure` | `message`, `quotaName`, `quotaValue` | The request was rejected because it attempted to create resources beyond the current Entity Resolution account limits. |
| `AddPolicyStatementInput` | `structure` | `action`, `arn`, `condition`, `effect`, `principal`, `statementId` | - |
| `AddPolicyStatementOutput` | `structure` | `arn`, `policy`, `token` | - |
| `BatchDeleteUniqueIdInput` | `structure` | `inputSource`, `uniqueIds`, `workflowName` | - |
| `BatchDeleteUniqueIdOutput` | `structure` | `deleted`, `disconnectedUniqueIds`, `errors`, `status` | - |
| `CreateIdMappingWorkflowInput` | `structure` | `description`, `idMappingTechniques`, `incrementalRunConfig`, `inputSourceConfig`, `outputSourceConfig`, `roleArn`, `tags`, `workflowName` | - |
| `CreateIdMappingWorkflowOutput` | `structure` | `description`, `idMappingTechniques`, `incrementalRunConfig`, `inputSourceConfig`, `outputSourceConfig`, `roleArn`, `workflowArn`, `workflowName` | - |
| `CreateIdNamespaceInput` | `structure` | `description`, `idMappingWorkflowProperties`, `idNamespaceName`, `inputSourceConfig`, `roleArn`, `tags`, `type` | - |
| `CreateIdNamespaceOutput` | `structure` | `createdAt`, `description`, `idMappingWorkflowProperties`, `idNamespaceArn`, `idNamespaceName`, `inputSourceConfig`, `roleArn`, `tags`, `type`, `updatedAt` | - |
| `CreateMatchingWorkflowInput` | `structure` | `description`, `incrementalRunConfig`, `inputSourceConfig`, `outputSourceConfig`, `resolutionTechniques`, `roleArn`, `tags`, `workflowName` | - |
| `CreateMatchingWorkflowOutput` | `structure` | `description`, `incrementalRunConfig`, `inputSourceConfig`, `outputSourceConfig`, `resolutionTechniques`, `roleArn`, `workflowArn`, `workflowName` | - |
| `CreateSchemaMappingInput` | `structure` | `description`, `mappedInputFields`, `schemaName`, `tags` | - |
| `CreateSchemaMappingOutput` | `structure` | `description`, `mappedInputFields`, `schemaArn`, `schemaName` | - |
