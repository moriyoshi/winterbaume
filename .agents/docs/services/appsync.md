...
- Common required input members in this group: `apiId`, `associationId`, `domainName`, `fieldName`, `format`, `functionId`, `introspectionId`, `mergedApiIdentifier`, `name`, `typeName`
...
- Traits: `paginated` (12)
- Common required input members in this group: `apiId`, `associationId`, `format`, `functionId`, `mergedApiIdentifier`, `resourceArn`, `typeName`
...
- Common required input members in this group: `apiCachingBehavior`, `apiId`, `associationId`, `authenticationType`, `dataSourceName`, `domainName`, `eventConfig`, `fieldName`, `format`, `functionId`, `id`, `mergedApiIdentifier`, `name`, `ttl`, `type`, `typeName`
...
- Common required input members in this group: `apiCachingBehavior`, `apiId`, `authenticationType`, `certificateArn`, `dataSourceName`, `definition`, `domainName`, `eventConfig`, `fieldName`, `format`, `name`, `ttl`, `type`, `typeName`
...
- Traits: `idempotent` (2)
- Common required input members in this group: `apiId`, `domainName`, `fieldName`, `functionId`, `id`, `name`, `typeName`

### Associate

- Operations: `AssociateApi`, `AssociateMergedGraphqlApi`, `AssociateSourceGraphqlApi`
- Common required input members in this group: `apiId`, `domainName`, `mergedApiIdentifier`, `sourceApiIdentifier`

### Disassociate

- Operations: `DisassociateApi`, `DisassociateMergedGraphqlApi`, `DisassociateSourceGraphqlApi`
- Common required input members in this group: `associationId`, `domainName`, `mergedApiIdentifier`, `sourceApiIdentifier`

### Start

- Operations: `StartDataSourceIntrospection`, `StartSchemaCreation`, `StartSchemaMerge`
- Common required input members in this group: `apiId`, `associationId`, `definition`, `mergedApiIdentifier`

### Evaluate

- Operations: `EvaluateCode`, `EvaluateMappingTemplate`
- Common required input members in this group: `code`, `context`, `runtime`, `template`

### Flush

- Operations: `FlushApiCache`
- Common required input members in this group: `apiId`

### Put

- Operations: `PutGraphqlApiEnvironmentVariables`
- Common required input members in this group: `apiId`, `environmentVariables`
...
|---|---|---|---|---|---|---|---|
| `AssociateApi` | `POST /v1/domainnames/{domainName}/apiassociation` | - | `apiId`, `domainName` | - | `AssociateApiResponse` | `AccessDeniedException`, `BadRequestException`, `InternalFailureException`, `NotFoundException` | Maps an endpoint to your custom domain. |
| `AssociateMergedGraphqlApi` | `POST /v1/sourceApis/{sourceApiIdentifier}/mergedApiAssociations` | - | `mergedApiIdentifier`, `sourceApiIdentifier` | - | `AssociateMergedGraphqlApiResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `LimitExceededException`, `NotFoundException`, `UnauthorizedException` | Creates an association between a Merged API and source API using the source API's identifier. |
...
| `CreateApi` | `POST /v2/apis` | - | `eventConfig`, `name` | - | `CreateApiResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `ServiceQuotaExceededException`, `UnauthorizedException` | Creates an `Api` object. Use this operation to create an AppSync API with your preferred configuration, such as an Event API that provides real-time message publishing and message subscriptions over WebSockets. |
| `CreateApiCache` | `POST /v1/apis/{apiId}/ApiCaches` | - | `apiCachingBehavior`, `apiId`, `ttl`, `type` | - | `CreateApiCacheResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Creates a cache for the GraphQL API. |
...
| `CreateDomainName` | `POST /v1/domainnames` | - | `certificateArn`, `domainName` | - | `CreateDomainNameResponse` | `AccessDeniedException`, `BadRequestException`, `InternalFailureException` | Creates a custom `DomainName` object. |
| `CreateFunction` | `POST /v1/apis/{apiId}/functions` | - | `apiId`, `dataSourceName`, `name` | - | `CreateFunctionResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Creates a `Function` object. A function is a reusable entity. |
| `CreateGraphqlApi` | `POST /v1/apis` | - | `authenticationType`, `name` | - | `CreateGraphqlApiResponse` | `ApiLimitExceededException`, `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `LimitExceededException`, `UnauthorizedException` | Creates a `GraphqlApi` object. |
| `CreateResolver` | `POST /v1/apis/{apiId}/types/{typeName}/resolvers` | - | `apiId`, `fieldName`, `typeName` | - | `CreateResolverResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Creates a `Resolver` object. A resolver converts incoming requests into a format that a data source can understand, and converts the data source's responses into GraphQL. |
...
| `DeleteResolver` | `DELETE /v1/apis/{apiId}/types/{typeName}/resolvers/{fieldName}` | - | `apiId`, `fieldName`, `typeName` | - | `DeleteResolverResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Deletes a `Resolver` object. |
...
| `DisassociateMergedGraphqlApi` | `DELETE /v1/sourceApis/{sourceApiIdentifier}/mergedApiAssociations/{associationId}` | - | `associationId`, `sourceApiIdentifier` | - | `DisassociateMergedGraphqlApiResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Deletes an association between a Merged API and source API using the source API's identifier and the association ID. |
| `DisassociateSourceGraphqlApi` | `DELETE /v1/mergedApis/{mergedApiIdentifier}/sourceApiAssociations/{associationId}` | - | `associationId`, `mergedApiIdentifier` | - | `DisassociateSourceGraphqlApiResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Deletes an association between a Merged API and source API using the Merged API's identifier and the association ID. |
| `EvaluateCode` | `POST /v1/dataplane-evaluatecode` | - | `code`, `context`, `runtime` | - | `EvaluateCodeResponse` | `AccessDeniedException`, `BadRequestException`, `InternalFailureException` | Evaluates the given code and returns the response. The code definition requirements depend on the specified runtime. |
| `EvaluateMappingTemplate` | `POST /v1/dataplane-evaluatetemplate` | - | `context`, `template` | - | `EvaluateMappingTemplateResponse` | `AccessDeniedException`, `BadRequestException`, `InternalFailureException` | Evaluates a given template and returns the response. The mapping template can be a request or response template. |
...
| `GetResolver` | `GET /v1/apis/{apiId}/types/{typeName}/resolvers/{fieldName}` | - | `apiId`, `fieldName`, `typeName` | - | `GetResolverResponse` | `ConcurrentModificationException`, `NotFoundException`, `UnauthorizedException` | Retrieves a `Resolver` object. |
...
| `GetSourceApiAssociation` | `GET /v1/mergedApis/{mergedApiIdentifier}/sourceApiAssociations/{associationId}` | - | `associationId`, `mergedApiIdentifier` | - | `GetSourceApiAssociationResponse` | `BadRequestException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Retrieves a `SourceApiAssociation` object. |
| `GetType` | `GET /v1/apis/{apiId}/types/{typeName}` | - | `apiId`, `format`, `typeName` | - | `GetTypeResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Retrieves a `Type` object. |
| `ListApiKeys` | `GET /v1/apis/{apiId}/apikeys` | `paginated` | `apiId` | - | `ListApiKeysResponse` | `BadRequestException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Lists the API keys for a given API. API keys are deleted automatically 60 days after they expire. |
| `ListApis` | `GET /v2/apis` | `paginated` | - | - | `ListApisResponse` | `BadRequestException`, `InternalFailureException`, `UnauthorizedException` | Lists the APIs in your AppSync account. `ListApis` returns only the high level API details. |
...
| `ListTypesByAssociation` | `GET /v1/mergedApis/{mergedApiIdentifier}/sourceApiAssociations/{associationId}/types` | `paginated` | `associationId`, `format`, `mergedApiIdentifier` | - | `ListTypesByAssociationResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Lists `Type` objects by the source API association ID. |
...
| `StartSchemaCreation` | `POST /v1/apis/{apiId}/schemacreation` | - | `apiId`, `definition` | - | `StartSchemaCreationResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Adds a new schema to your GraphQL API. This operation is asynchronous. |
...
| `UpdateApi` | `POST /v2/apis/{apiId}` | - | `apiId`, `eventConfig`, `name` | - | `UpdateApiResponse` | `AccessDeniedException`, `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Updates an `Api`. |
| `UpdateApiCache` | `POST /v1/apis/{apiId}/ApiCaches/update` | - | `apiCachingBehavior`, `apiId`, `ttl`, `type` | - | `UpdateApiCacheResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Updates the cache for the GraphQL API. |
...
| `UpdateFunction` | `POST /v1/apis/{apiId}/functions/{functionId}` | - | `apiId`, `dataSourceName`, `functionId`, `name` | - | `UpdateFunctionResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Updates a `Function` object. |
| `UpdateGraphqlApi` | `POST /v1/apis/{apiId}` | - | `apiId`, `authenticationType`, `name` | - | `UpdateGraphqlApiResponse` | `AccessDeniedException`, `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Updates a `GraphqlApi` object. |
| `UpdateResolver` | `POST /v1/apis/{apiId}/types/{typeName}/resolvers/{fieldName}` | - | `apiId`, `fieldName`, `typeName` | - | `UpdateResolverResponse` | `BadRequestException`, `ConcurrentModificationException`, `InternalFailureException`, `NotFoundException`, `UnauthorizedException` | Updates a `Resolver` object. |
...
|---|---|---|---|
| `InternalFailureException` | `structure` | `message` | An internal AppSync error occurred. |
| `BadRequestException` | `structure` | `detail`, `message`, `reason` | The request is not well formed. |
...
| `LimitExceededException` | `structure` | `message` | The request exceeded a limit. |
...
| `AssociateApiRequest` | `structure` | `apiId`, `domainName` | - |
| `AssociateApiResponse` | `structure` | `apiAssociation` | - |
| `AssociateMergedGraphqlApiRequest` | `structure` | `description`, `mergedApiIdentifier`, `sourceApiAssociationConfig`, `sourceApiIdentifier` | - |
| `AssociateMergedGraphqlApiResponse` | `structure` | `sourceApiAssociation` | - |
| `AssociateSourceGraphqlApiRequest` | `structure` | `description`, `mergedApiIdentifier`, `sourceApiAssociationConfig`, `sourceApiIdentifier` | - |
| `AssociateSourceGraphqlApiResponse` | `structure` | `sourceApiAssociation` | - |
| `CreateApiRequest` | `structure` | `eventConfig`, `name`, `ownerContact`, `tags` | - |
| `CreateApiResponse` | `structure` | `api` | - |
| `CreateApiCacheRequest` | `structure` | `apiCachingBehavior`, `apiId`, `atRestEncryptionEnabled`, `healthMetricsConfig`, `transitEncryptionEnabled`, `ttl`, `type` | Represents the input of a `CreateApiCache` operation. |
...
| `ApiKeyLimitExceededException` | `structure` | `message` | The API key exceeded a limit. |
| `CreateChannelNamespaceRequest` | `structure` | `apiId`, `codeHandlers`, `handlerConfigs`, `name`, `publishAuthModes`, `subscribeAuthModes`, `tags` | - |
