...
- Operations: `ListArtifacts`, `ListDeviceInstances`, `ListDevicePools`, `ListDevices`, `ListInstanceProfiles`, `ListJobs`, `ListNetworkProfiles`, `ListOfferingPromotions`, `ListOfferingTransactions`, `ListOfferings`, `ListProjects`, `ListRemoteAccessSessions`, `ListRuns`, `ListSamples`, `ListSuites`, `ListTagsForResource`, `ListTestGridProjects`, `ListTestGridSessionActions`, `ListTestGridSessionArtifacts`, `ListTestGridSessions`, `ListTests`, `ListUniqueProblems`, `ListUploads`, `ListVPCEConfigurations`
- Traits: `paginated` (17)
- Common required input members in this group: `ResourceARN`, `arn`, `projectArn`, `sessionArn`, `type`
...
- Traits: `paginated` (1)
- Common required input members in this group: `arn`, `devicePoolArn`, `projectArn`
...
- Common required input members in this group: `deviceArn`, `expiresInSeconds`, `name`, `projectArn`, `rules`, `serviceDnsName`, `type`, `vpceConfigurationName`, `vpceServiceName`
...
- Common required input members in this group: `arn`, `projectArn`
...
- Common required input members in this group: `appArn`, `remoteAccessSessionArn`

### Purchase

- Operations: `PurchaseOffering`
- Common required input members in this group: `offeringId`, `quantity`
...
- Common required input members in this group: `projectArn`, `test`
...
|---|---|---|---|---|---|---|---|
| `CreateDevicePool` | - | - | `name`, `projectArn`, `rules` | - | `CreateDevicePoolResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Creates a device pool. |
...
| `CreateNetworkProfile` | - | - | `name`, `projectArn` | - | `CreateNetworkProfileResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Creates a network profile. |
...
| `CreateRemoteAccessSession` | - | - | `deviceArn`, `projectArn` | - | `CreateRemoteAccessSessionResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Specifies and starts a remote access session. |
...
| `CreateTestGridUrl` | - | - | `expiresInSeconds`, `projectArn` | - | `CreateTestGridUrlResult` | `ArgumentException`, `InternalServiceException`, `NotFoundException` | Creates a signed, short-term URL that can be passed to a Selenium `RemoteWebDriver` constructor. |
| `CreateUpload` | - | - | `name`, `projectArn`, `type` | - | `CreateUploadResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Uploads an app or test scripts. |
| `CreateVPCEConfiguration` | - | - | `serviceDnsName`, `vpceConfigurationName`, `vpceServiceName` | - | `CreateVPCEConfigurationResult` | `ArgumentException`, `LimitExceededException`, `ServiceAccountException` | Creates a configuration record in Device Farm for your Amazon Virtual Private Cloud (VPC) endpoint. |
...
| `DeleteProject` | - | - | `arn` | - | `DeleteProjectResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Deletes an AWS Device Farm project, given the project ARN. You cannot delete a project if it has an active run or session. |
| `DeleteRemoteAccessSession` | - | - | `arn` | - | `DeleteRemoteAccessSessionResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Deletes a completed remote access session and its results. You cannot delete a remote access session if it is still active. |
| `DeleteRun` | - | - | `arn` | - | `DeleteRunResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Deletes the run, given the run ARN. You cannot delete a run if it is still active. |
| `DeleteTestGridProject` | - | - | `projectArn` | - | `DeleteTestGridProjectResult` | `ArgumentException`, `CannotDeleteException`, `InternalServiceException`, `NotFoundException` | Deletes a Selenium testing project and all content generated under it. You cannot delete a project if it has active sessions. |
...
| `GetOfferingStatus` | - | `paginated` | - | - | `GetOfferingStatusResult` | `ArgumentException`, `LimitExceededException`, `NotEligibleException`, `NotFoundException`, `ServiceAccountException` | Gets the current status and future status of all offerings purchased by an AWS account. The response indicates how many offerings are currently available and the offerings that will be available in the next period. |
...
| `InstallToRemoteAccessSession` | - | - | `appArn`, `remoteAccessSessionArn` | - | `InstallToRemoteAccessSessionResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Installs an application to the device in a remote access session. For Android applications, the file must be in .apk format. |
...
| `ListOfferingPromotions` | - | - | - | - | `ListOfferingPromotionsResult` | `ArgumentException`, `LimitExceededException`, `NotEligibleException`, `NotFoundException`, `ServiceAccountException` | Returns a list of offering promotions. Each offering promotion record contains the ID and description of the promotion. |
...
| `ListUniqueProblems` | - | `paginated` | `arn` | - | `ListUniqueProblemsResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Gets information about unique problems, such as exceptions or crashes. Unique problems are defined as a single instance of an error across a run, job, or suite. |
...
| `StopJob` | - | - | `arn` | - | `StopJobResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Initiates a stop request for the current job. AWS Device Farm immediately stops the job on the device where tests have not started. |
...
| `StopRun` | - | - | `arn` | - | `StopRunResult` | `ArgumentException`, `LimitExceededException`, `NotFoundException`, `ServiceAccountException` | Initiates a stop request for the current test run. AWS Device Farm immediately stops the run on devices where tests have not started. |
...
| `InternalServiceException` | `structure` | `message` | An internal exception was raised in the service. |
...
| `TagOperationException` | `structure` | `message`, `resourceName` | The operation was not successful. |
...
| `CreateDevicePoolRequest` | `structure` | `description`, `maxDevices`, `name`, `projectArn`, `rules` | Represents a request to the create device pool operation. |
| `CreateDevicePoolResult` | `structure` | `devicePool` | Represents the result of a create device pool request. |
| `CreateInstanceProfileRequest` | `structure` | `description`, `excludeAppPackagesFromCleanup`, `name`, `packageCleanup`, `rebootAfterUse` | - |
| `CreateInstanceProfileResult` | `structure` | `instanceProfile` | - |
| `CreateNetworkProfileRequest` | `structure` | `description`, `downlinkBandwidthBits`, `downlinkDelayMs`, `downlinkJitterMs`, `downlinkLossPercent`, `name`, `projectArn`, `type`, `uplinkBandwidthBits`, `uplinkDelayMs`, `uplinkJitterMs`, `uplinkLossPercent` | - |
| `CreateNetworkProfileResult` | `structure` | `networkProfile` | - |
| `CreateProjectRequest` | `structure` | `defaultJobTimeoutMinutes`, `environmentVariables`, `executionRoleArn`, `name`, `vpcConfig` | Represents a request to the create project operation. |
| `CreateProjectResult` | `structure` | `project` | Represents the result of a create project request. |
| `CreateRemoteAccessSessionRequest` | `structure` | `appArn`, `configuration`, `deviceArn`, `instanceArn`, `interactionMode`, `name`, `projectArn`, `skipAppResign` | Creates and submits a request to start a remote access session. |
...
| `CreateTestGridProjectRequest` | `structure` | `description`, `name`, `vpcConfig` | - |
| `CreateTestGridProjectResult` | `structure` | `testGridProject` | - |
| `CreateTestGridUrlRequest` | `structure` | `expiresInSeconds`, `projectArn` | - |
| `CreateTestGridUrlResult` | `structure` | `expires`, `url` | - |
| `CreateUploadRequest` | `structure` | `contentType`, `name`, `projectArn`, `type` | Represents a request to the create upload operation. |
