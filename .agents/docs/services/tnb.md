...
- Traits: `readonly` (9)
- Common required input members in this group: `vnfPkgId`, `accept`, `nsdInfoId`
...
- Traits: `idempotent` (2)
- Common required input members in this group: `file`
...
| `CreateSolNetworkInstance` | `POST /sol/nslcm/v1/ns_instances` | - | `nsdInfoId`, `nsName` | - | `CreateSolNetworkInstanceOutput` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ServiceQuotaExceededException`, `ThrottlingException`, `ValidationException` | Creates a network instance. A network instance is a single network created in Amazon Web Services TNB that can be deployed and on which life-cycle operations (like terminate, update, and delete) can be performed. Cre ... |
| `CreateSolNetworkPackage` | `POST /sol/nsd/v1/ns_descriptors` | - | - | - | `CreateSolNetworkPackageOutput` | `AccessDeniedException`, `InternalServerException`, `ServiceQuotaExceededException`, `ThrottlingException`, `ValidationException` | Creates a network package. A network package is a .zip file in CSAR (Cloud Service Archive) format defines the function packages you want to deploy and the Amazon Web Services infrastructure you want to deploy them o ... |
...
| `DeleteSolNetworkInstance` | `DELETE /sol/nslcm/v1/ns_instances/{nsInstanceId}` | `idempotent` | `nsInstanceId` | - | `Unit` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ThrottlingException`, `ValidationException` | Deletes a network instance. A network instance is a single network created in Amazon Web Services TNB that can be deployed and on which life-cycle operations (like terminate, update, and delete) can be performed. To ... |
...
| `ListSolNetworkOperations` | `GET /sol/nslcm/v1/ns_lcm_op_occs` | `readonly`, `paginated` | - | - | `ListSolNetworkOperationsOutput` | `AccessDeniedException`, `InternalServerException`, `ThrottlingException`, `ValidationException` | Lists details for a network operation, including when the operation started and the status of the operation. A network operation is any operation that is done to your network, such as network instance instantiation o ... |
...
| `PutSolFunctionPackageContent` | `PUT /sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}/package_content` | `idempotent` | `vnfPkgId`, `file` | - | `PutSolFunctionPackageContentOutput` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ThrottlingException`, `ValidationException` | Uploads the contents of a function package. A function package is a .zip file in CSAR (Cloud Service Archive) format that contains a network function (an ETSI standard telecommunication application) and function pack ... |
| `PutSolNetworkPackageContent` | `PUT /sol/nsd/v1/ns_descriptors/{nsdInfoId}/nsd_content` | `idempotent` | `nsdInfoId`, `file` | - | `PutSolNetworkPackageContentOutput` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ThrottlingException`, `ValidationException` | Uploads the contents of a network package. A network package is a .zip file in CSAR (Cloud Service Archive) format defines the function packages you want to deploy and the Amazon Web Services infrastructure you want ... |
| `TagResource` | `POST /tags/{resourceArn}` | `idempotent` | `resourceArn`, `tags` | - | `TagResourceOutput` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ThrottlingException`, `ValidationException` | Tags an AWS TNB resource. A tag is a label that you assign to an Amazon Web Services resource. Each tag consists of a key and an optional value. You can use tags to search and filter your resources or track your Amaz ... |
...
| `UntagResource` | `DELETE /tags/{resourceArn}` | `idempotent` | `resourceArn`, `tagKeys` | - | `UntagResourceOutput` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ThrottlingException`, `ValidationException` | Untags an AWS TNB resource. A tag is a label that you assign to an Amazon Web Services resource. Each tag consists of a key and an optional value. You can use tags to search and filter your resources or track your Am ... |
| `UpdateSolFunctionPackage` | `PATCH /sol/vnfpkgm/v1/vnf_packages/{vnfPkgId}` | - | `vnfPkgId`, `operationalState` | - | `UpdateSolFunctionPackageOutput` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ThrottlingException`, `ValidationException` | Updates the operational state of function package. A function package is a .zip file in CSAR (Cloud Service Archive) format that contains a network function (an ETSI standard telecommunication application) and functi ... |
| `UpdateSolNetworkInstance` | `POST /sol/nslcm/v1/ns_instances/{nsInstanceId}/update` | - | `nsInstanceId`, `updateType` | - | `UpdateSolNetworkInstanceOutput` | `AccessDeniedException`, `InternalServerException`, `ResourceNotFoundException`, `ServiceQuotaExceededException`, `ThrottlingException`, `ValidationException` | Update a network instance. A network instance is a single network created in Amazon Web Services TNB that can be deployed and on which life-cycle operations (like terminate, update, and delete) can be performed. Choo ... |
...
| `InternalServerException` | `structure` | message | Unexpected error occurred. Problem on the server. |
...
| `CreateSolFunctionPackageOutput` | `structure` | id, arn, onboardingState, operationalState, usageState, tags | - |
| `CreateSolNetworkInstanceInput` | `structure` | nsdInfoId, nsName, nsDescription, tags | - |
| `CreateSolNetworkInstanceOutput` | `structure` | id, arn, nsdInfoId, nsInstanceName, tags | - |
| `CreateSolNetworkPackageInput` | `structure` | tags | - |
| `CreateSolNetworkPackageOutput` | `structure` | id, arn, nsdOnboardingState, nsdOperationalState, nsdUsageState, tags | - |
...
| `GetSolFunctionInstanceOutput` | `structure` | id, arn, nsInstanceId, vnfPkgId, vnfdId, vnfProvider, vnfProductName, vnfdVersion, instantiationState, instantiatedVnfInfo, metadata, tags | - |
| `GetSolFunctionPackageInput` | `structure` | vnfPkgId | - |
| `GetSolFunctionPackageOutput` | `structure` | id, arn, onboardingState, operationalState, usageState, vnfdId, vnfProvider, vnfProductName, vnfdVersion, metadata, tags | - |
| `GetSolFunctionPackageContentInput` | `structure` | vnfPkgId, accept | - |
| `GetSolFunctionPackageContentOutput` | `structure` | contentType, packageContent | - |
| `GetSolFunctionPackageDescriptorInput` | `structure` | vnfPkgId, accept | - |
| `GetSolFunctionPackageDescriptorOutput` | `structure` | contentType, vnfd | - |
| `GetSolNetworkInstanceInput` | `structure` | nsInstanceId | - |
| `GetSolNetworkInstanceOutput` | `structure` | id, arn, nsInstanceName, nsInstanceDescription, nsdId, nsdInfoId, nsState, lcmOpInfo, metadata, tags | - |
| `GetSolNetworkOperationInput` | `structure` | nsLcmOpOccId | - |
| `GetSolNetworkOperationOutput` | `structure` | id, arn, operationState, nsInstanceId, lcmOperationType, updateType, error, metadata, tasks, tags | - |
| `GetSolNetworkPackageInput` | `structure` | nsdInfoId | - |
| `GetSolNetworkPackageOutput` | `structure` | id, arn, nsdOnboardingState, nsdOperationalState, nsdUsageState, nsdId, nsdName, nsdVersion, vnfPkgIds, metadata, tags | - |
| `GetSolNetworkPackageContentInput` | `structure` | nsdInfoId, accept | - |
| `GetSolNetworkPackageContentOutput` | `structure` | contentType, nsdContent | - |
| `GetSolNetworkPackageDescriptorInput` | `structure` | nsdInfoId | - |
| `GetSolNetworkPackageDescriptorOutput` | `structure` | contentType, nsd | - |
| `InstantiateSolNetworkInstanceInput` | `structure` | nsInstanceId, dryRun, additionalParamsForNs, tags | - |
| `InstantiateSolNetworkInstanceOutput` | `structure` | nsLcmOpOccId, tags | - |
| `ListSolFunctionInstancesInput` | `structure` | maxResults, nextToken | - |
| `ListSolFunctionInstancesOutput` | `structure` | nextToken, functionInstances | - |
| `ListSolFunctionPackagesInput` | `structure` | maxResults, nextToken | - |
| `ListSolFunctionPackagesOutput` | `structure` | nextToken, functionPackages | - |
| `DescriptorContentType` | `enum` | TEXT_PLAIN | - |
| `LcmOperationType` | `enum` | INSTANTIATE, UPDATE, TERMINATE | - |
| `NsLcmOperationState` | `enum` | PROCESSING, COMPLETED, FAILED, CANCELLING, CANCELLED | - |
| `NsState` | `enum` | INSTANTIATED, NOT_INSTANTIATED, UPDATED, IMPAIRED, UPDATE_FAILED, STOPPED, DELETED, INSTANTIATE_IN_PROGRESS, INTENT_TO_UPDATE_IN_PROGRESS, UPDATE_IN_PROGRESS, TERMINATE_IN_PROGRESS | - |
| `NsdOnboardingState` | `enum` | CREATED, ONBOARDED, ERROR | - |
| `NsdOperationalState` | `enum` | ENABLED, DISABLED | - |
| `NsdUsageState` | `enum` | IN_USE, NOT_IN_USE | - |
| `OnboardingState` | `enum` | CREATED, ONBOARDED, ERROR | - |
| `OperationalState` | `enum` | ENABLED, DISABLED | - |
| `PackageContentType` | `enum` | APPLICATION_ZIP | - |
