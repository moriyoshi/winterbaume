...
| `CreateSyncConfigurationInput` | `structure` | Branch, ConfigFile, RepositoryLinkId, ResourceName, RoleArn, SyncType, PublishDeploymentStatus, TriggerResourceUpdateOn, PullRequestComment | - |
...
| `ProviderType` | `enum` | BITBUCKET, GITHUB, GITHUB_ENTERPRISE_SERVER, GITLAB, GITLAB_SELF_MANAGED, AZURE_DEV_OPS | - |
| `PublishDeploymentStatus` | `enum` | ENABLED, DISABLED | - |
| `PullRequestComment` | `enum` | ENABLED, DISABLED | - |
